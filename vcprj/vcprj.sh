...
#python3 ./vcprj.py --jsonin=./vcprj_CMakePresets.json --jsonout=../CMakePresets.json --verbose --sys=$sys
#exit_code=$?
#if [ $exit_code -ne 0 ]; then
#    echo "Error: Failed to execute the parsing of vcprj_CMakePresets."
#    exit $exit_code
#fi
