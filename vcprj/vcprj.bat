...
REM python vcprj.py --jsonin=vcprj_CMakePresets.json --jsonout=../CMakePresets.json --verbose --sys=%sys%
REM IF %ERRORLEVEL% NEQ 0 (
REM    echo Error: Failed to execute the parsing of vcprj_CMakePresets.
